...
GATE_REGISTRY: tuple[GateDefinition, ...] = (
    GateDefinition(
        ...
        "Brief confirmed",
        "human",
        "src/thesisound/web/app.py:791",
        "Project brief",
        "SOURCES_COLLECTING state",
        "The operator has not confirmed the brief.",
    ),
    GateDefinition(
        ...
        "Source selection confirmed",
        "human",
        "src/thesisound/web/source_routes.py:576",
        "Selected source manifest",
        "CORPUS_CONFIRMED state",
    ...
    GateDefinition(
        ...
        "Parse quality",
        "machine",
        "src/thesisound/services/parse_quality.py:15",
        "Parsed documents",
    ...
    GateDefinition(
        ...
        "machine",
        "src/thesisound/services/evidence_validator.py:51",
    ...
    GateDefinition(
        ...
        "Evidence retention",
        "machine",
        "src/thesisound/services/source_analysis_service.py:37",
    ...
    GateDefinition(
        ...
        "Episode Plan approval",
        "human",
        "src/thesisound/services/plan_approval.py:57",
        "Episode Plan",
    ...
    GateDefinition(
        ...
        "machine",
        "src/thesisound/services/script_checks.py:26",
    ...
    GateDefinition(
        ...
        "Independent verification",
        "machine",
        "src/thesisound/services/script_verifier.py:12",
    ...
    GateDefinition(
        ...
        "Script review decision",
        "human",
        "src/thesisound/web/script_routes.py:116",
    ...
    GateDefinition(
        ...
        "Audio QA",
        "machine",
        "src/thesisound/services/audio_pipeline_service.py:205",
        "Audio QA report",
