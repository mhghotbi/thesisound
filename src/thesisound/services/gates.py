...
GATE_REGISTRY: tuple[GateDefinition, ...] = (
    ...
    GateDefinition(
        ...
        "Source selection confirmed",
        "human",
        "src/thesisound/web/source_routes.py:610",
    ...
    GateDefinition(
        ...
        "machine",
        "src/thesisound/services/script_checks.py:185",
    ...
    GateDefinition(
        ...
        "Independent verification",
        "machine",
        "src/thesisound/services/script_verifier.py:30",
    ...
    GateDefinition(
        ...
        "Script review decision",
        "human",
        "src/thesisound/web/script_routes.py:114",
