...
- weight is how strong the relation is, 0–1. Take it from the edge type, not from how good the edge feels: prerequisite 0.8–1.0; extends and depends_on 0.5–0.7; contrasts 0.4–0.7; related 0.1–0.4; objects_to, responds_to and instance_of 0.5–0.8. confidence is how sure you are the edge is correct.
