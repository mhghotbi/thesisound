...
- Set required_for_global_understanding on a section only when a listener who skipped it would misunderstand a later section. It is not a mark of quality or interest. In a map of N sections expect roughly N/5 to qualify; if you are marking more than a third of them, you are using the wrong test.
