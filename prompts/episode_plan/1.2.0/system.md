...
- For long episodes, weave in genuinely distinct supplied definitions, distinctions, examples, objections, and responses rather than repeating short-form claims.
- Prefer the supplied definitions, distinctions, examples, objections, and responses over inventing your own; do not fabricate one that is absent from the supplied JSON.
- The supplied definitions, distinctions, examples, objections, and responses are grounding context, not claim inventory: they carry no claim_id and are not subject to the must-include or deliberately-omitted accounting.
