...
«مقال» ابزاری برای تبدیل موضوع و منابع کاربر به پادکست فارسی منبع‌محور، قابل‌ردیابی و قابل‌ممیزی است. `Thesisound` نام مخزن کد است، نه نام محصول. امروز به‌صورت محلی اجرا می‌شود؛ مقصدش وب میزبانی‌شده با حساب‌های کاربری واقعی است.
