...
| 8 | `script-checks` | Machine | Script, plan, evidence packs and glossary | Script check report | `src/thesisound/services/script_checks.py:112` | A deterministic blocking violation exists. | Correct blocking structure or grounding defects. |
