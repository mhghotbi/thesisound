# 04 — Self-hosted multilingual OCR

Related: OCR routing decision is part of [`../02-pipeline/01-document-ingestion.md`](../02-pipeline/01-document-ingestion.md)'s parser selection; OCR calls are outside the unified Gemini/Okian ledger in [`05-model-observability.md`](05-model-observability.md).
