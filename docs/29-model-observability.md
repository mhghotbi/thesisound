# Unified model-call observability

Thesisound records every Gemini interaction through one observed-call contract. The contract covers structured text generation, Google Search grounding, URL Context, TTS, and ASR.
