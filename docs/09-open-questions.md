...
این موارد هنوز تصمیم نهایی نیستند. developer نباید با تکیه بر حدس، آن‌ها را در معماری تثبیت کند.
...
## OQ-005 — Search provider اصلی چیست؟

### فرض فعلی

OpenAlex + Firecrawl کافی برای MVP.

### trigger Semantic Scholar

- citation graph لازم؛
- recommendation از seed paper؛
- coverage OpenAlex در رشته هدف ناکافی.
