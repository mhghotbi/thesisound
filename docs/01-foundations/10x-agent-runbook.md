...
| C-D | ✔ | **چک‌پوینت D** — `source_coverage` سرتاسری روی منبع واقعی | جزئی 2026-08-20 (نکات در STATUS.md) |
...
| 25 | P6 | ارزیابی روی یک منبع کامل + cleanup | جزئی 2026-08-20 (cleanup ایمن انجام شد؛ اجرای واقعی مسدود، در STATUS.md) |
