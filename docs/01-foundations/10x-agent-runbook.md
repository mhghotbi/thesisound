...
| 10 | P1 | Pass 4/4.5/5 — یال‌ها، ارتقای tier، آمار | |
| 11 | P1 | orchestration + کش + overlay + resume | |
| 12 | P1 | CLI `concept-map` + صفحهٔ نقشه | |
| C-B | ✔ | **چک‌پوینت B** — نقشهٔ یک منبع واقعی | |
...
| 20 | P3 | `part_packer` | |
| 21 | P3 | `segment_skeleton` + حلقهٔ plan per-part + ۵ نقطهٔ شرطی | |
...
| C-E | ✔ | **چک‌پوینت E** — UI و تجربهٔ مالک | |
| 25 | P6 | ارزیابی روی یک منبع کامل + cleanup | |
