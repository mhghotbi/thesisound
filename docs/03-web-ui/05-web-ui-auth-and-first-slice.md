# 05 — Web UI، Session و OTP

as-built؛ پیاده‌سازی می‌کند و جایگزین بخش auth-محور طراحی اولیه در [`01-operator-user-workflow.md`](01-operator-user-workflow.md) می‌شود.
