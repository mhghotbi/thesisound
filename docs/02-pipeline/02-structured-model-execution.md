# 02 — Structured model execution

این subsystem تمام stageهای مدل‌محور Thesisound را پشت یک contract مشترک قرار می‌دهد. هیچ service نباید مستقیماً SDK گوگل یا provider دیگری را فراخوانی کند. این contract را [`03-one-source-evidence-pipeline.md`](03-one-source-evidence-pipeline.md)، [`05-episode-preparation.md`](05-episode-preparation.md) و [`06-persian-script-pipeline.md`](06-persian-script-pipeline.md) مستقیماً مصرف می‌کنند.
