# Final visible case matrix — pre-freeze

This is the final v1 disposition of the Phase-1 proposal after Opus review/reconciliation. It does not replace or rewrite `CASE-MATRIX.md`; see `AUDIT-TRAIL.md`. No row contains gold or an expected answer.

## Release-gating core (12 visible cases)
...
| Case | Settled design | Status |
|---|---|---|
| V13 (burned H13) | Bounded UNESCO/NIST scopes; typed direct support, partial overlap, tension, or no counterpart; non-mappings explicitly allowed | **BLOCKED for fixture/licence work; visible and non-gating** |
| V14 (burned H14) | Heat extremes only; bounded IPCC Chapter 11 plus Bellprat et al. | **BLOCKED for fixture/right strategy; visible and non-gating** |

## Deferred designs retained in history

- Original C05 remains deferred until M8 implements cross-source reconciliation. C05R fills the v1 slot; it does not rehabilitate or erase C05.
- C12 remains deferred to v1.1. Its failed-source analysis and design remain in the Phase-1/Opus artifacts, and no replacement was force-filled.
- H13, H14, and H15 are burned as hidden holdouts because their semantics are public. They survive only as V13, V14, and V15 dispositions.
- Three future hidden holdouts have only opaque public records. No source, author, topic, Research Brief, failure description, source text, expected atom, or gold was authored for them.
